...
| OperationContext.sourceId 必填 | `src/core/operations.ts:386-393` |
| AuthInfo sourceId + allowedSources | `src/core/operations.ts:246-274` |
| sourceScopeOpts precedence | `src/core/operations.ts:417-426` |
| linkReadScopeOpts remote promote | `src/core/operations.ts:443-448` |
| resolveRequestedSourceScope fail-closed | `src/core/operations.ts:451-468` 注释 |
